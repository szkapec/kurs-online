  ...
  return (
    ...
    <StyledComponentsFooter>
      <StyledComponents>
        ...
        <div className="image-rotator"><div className="rotator-slide" id="rotator-slide-1">
  <a href="https://www.darmowylicznik.pl/" title="Przejdź na stronę licznika" target="_blank">
    <img src="https://www.darmowylicznik.pl/licznik.php?id=142627" alt="Darmowy licznik odwiedzin" /></a></div></div>
      </StyledComponents>
